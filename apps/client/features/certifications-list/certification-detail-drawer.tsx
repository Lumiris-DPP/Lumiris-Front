        ...
        <div className="space-y-4 text-sm">
            <div className="grid grid-cols-2 gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                    <span className="text-muted-foreground text-[10px] uppercase tracking-wider">Statut</span>
                    <span>
...
function LinkedPassportsTab({ linked }: { linked: ReadonlyArray<{ id: string; reference: string; status: string }> }) {
    if (linked.length === 0) {
        return <p className="text-muted-foreground text-sm">Aucun passeport n’utilise cette certification.</p>;
    }
    return (
