            ...
            <motion.div className="w-full max-w-sm" variants={slideUpFade} initial="initial" animate="animate">
                <GlassCard className="p-7">
                    <header className="flex flex-col items-center text-center">
                        ...
                        <h1 className="mt-1 text-2xl font-bold tracking-tight text-foreground">Vision</h1>
                    ...
                    <ul className="mt-7 flex flex-col gap-3">
                        {VALUES.map(({ Icon, label }) => (
                            <li key={label} className="flex items-center gap-3">
                                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-border/60 bg-background/60">
                    ...
                    <div className="mt-7 flex flex-col gap-2">
                        ...
                        <Button
                            ...
                            disabled={navigating}
                            className="h-11 w-full rounded-full text-sm text-foreground hover:bg-foreground/5"
                        >
