        ...
        <FeatureLayout title="Signaux" description="Anomalies système, fraudes et anti-conflit d'intérêt — unifiés.">
            <div className="space-y-10">
                <section className="space-y-3">
                    <header>
                        <h2 className="text-base font-semibold text-foreground">Anomalies système</h2>
                ...
                <section className="space-y-3">
                    <header>
                        <h2 className="text-base font-semibold text-foreground">Détections affiliation</h2>
                        <p className="text-xs text-muted-foreground">
